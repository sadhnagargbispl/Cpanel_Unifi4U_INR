    ...
    <div class="col-md-12">
        <div id="ctl00_ContentPlaceHolder1_divgenexbusiness" class="clearfix gen-profile-box">
            <div class="profile-bar-simple red-border clearfix">
                <h6>Change Withdrawl Password                </h6>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputdefault">
                                    Old Withdrawl Password<span class="red">*</span></label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="oldpass"
                                    runat="server">Old Withdrawl Password can't left blank</asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                <label for="inputdefault">
                                    New Withdrawl Password<span class="red">*</span></label>
                                <asp:TextBox ID="pass1" class="form-control"
                                    TextMode="Password" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ControlToValidate="pass1"
                                    runat="server" ErrorMessage="RequiredFieldValidator"> New Withdrawl  Password Can't left blank</asp:RequiredFieldValidator>
                                <%-- <asp:RegularExpressionValidator ID="regex" runat="server" ControlToValidate="Pass1"
                            ErrorMessage="Password Length Minimum 5 or Maximum 20 characters" ValidationExpression="^[0-9A-Za-z_@$*]{5,20}$"></asp:RegularExpressionValidator>--%>
                            </div>
                            <div class="form-group">
                                <label for="inputdefault">
                                    Confirm Withdrawl Password<span class="red">*</span></label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" ControlToValidate="pass1"
                                    runat="server" ErrorMessage="RequiredFieldValidator">confirm Withdrawl New Password can't left blank</asp:RequiredFieldValidator>
