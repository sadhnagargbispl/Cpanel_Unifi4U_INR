...
public partial class WalletRequestDetail : System.Web.UI.Page
{
    ...
    private void PaymentDetails()
    {
        try
        {
            ...
            strquery += " from " + Obj.dBName + "..WalletReqINR " + " as a," + Obj.dBName + "..M_BankMaster as b where a.BankId=b.BankCode and b.RowStatus='Y' and a.Formno='" + Session["Formno"] + "' order by ReqNo desc ";
