    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (Request["Type"] == "Payment")
            {
                ...
                string sql = "select Case when ScannedFile='' then '' else 'images/UploadImage/' + ScannedFile end as ImagePath from WalletReqINR where ReqNo='" + Convert.ToInt32(Request["ID"]) + "'";
                dt = obj.GetData(sql);
