...
public class DAL
{
    ...
    public string Isostart = " Alter Database UnifiSelect Set Allow_SnapShot_isolation on; Set Transaction Isolation level read uncommitted;Set nocount on; Begin Tran  ";
    public string IsoEnd = " Commit Tran ";
    public string dBName = "Unifi";
