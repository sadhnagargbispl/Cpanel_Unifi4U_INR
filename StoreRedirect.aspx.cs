...
public partial class StoreRedirect : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("https://store.unifi4u.com/");
            }
            else
            {
                string formPostText = "";
                formPostText = "<form method=\"POST\" action=\"https://store.unifi4u.com/members/index.php\" name=\"frm2Post\">";
                formPostText += "<input type=\"hidden\" name=\"token\" value=\"0cd84028dc359ef17ad4456537477aad\" />";
