        ...
        try
        {
            if (Session["Idno"].ToString().Trim().ToUpper() != txtMemberId.Text.Trim().ToUpper())
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string strSql_ = "Select count(a.formnodwn) as Cnt from " + Obj.dBName + "..R_MemTreeRelation as a," + Obj.dBName + "..M_memberMaster as b where a.FormNodwn = b.FormNo and a.MLevel >= 1";
