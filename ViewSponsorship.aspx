<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSponsorship.aspx.cs" Inherits="ViewSponsorship" %>
...
<body>
    ...
    <div style="margin-bottom: 10px; padding-right: 20px; padding-left: 20px; padding-top: 20px">
        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="true"
            GridLines="Both" AllowPaging="true" CssClass="table table-bordered"  HeaderStyle-HorizontalAlign ="Left" 
