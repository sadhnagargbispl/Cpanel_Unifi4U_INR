...
public partial class GroupbusinessDate : System.Web.UI.Page
{
    ...
    private void Filltotal(string Formno, string dwnFormno)
    {
        try
        {
            ...
            string strSql = ObjDal.Isostart + " Exec Sp_MydirectReportDateINR '" + Formno + "','" + dwnFormno + "','" + TxtFromDate.Text + "','" + TxtToDate.Text + "'" + ObjDal.IsoEnd;
    ...
    private void LoadDownline(string FormNo)
    {
        try
        {
            ...
            string strSql = ObjDal.Isostart + " Exec Sp_MydirectReportNewDateINR '" + FormNo + "','" + TxtFromDate.Text + "','" + TxtToDate.Text + "'" + ObjDal.IsoEnd;
