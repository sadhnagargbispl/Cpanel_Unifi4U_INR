(function () {
    ...
    */
    ...
    function Ba(a) {
        ...
        (b = a.l = a.l || b) ? b.Ya ? a.i = a.v || a.m : void 0 != b.s && a.m < b.s ? (a.i = b.s, a.l = null) : a.i = a.m: a.i = 0
    }
    ...
    function Ga(a) {
        this.next = function (b) {
            ua(a.i);
            a.i.o ? b = Ea(a, a.i.o.next, b, a.i.C) : (a.i.C(b), b = Fa(a));
            return b
        };
        this.throw = function (b) {
            ua(a.i);
            a.i.o ? b = Ea(a, a.i.o["throw"], b, a.i.C) : (wa(a.i, b), b = Fa(a));
            return b
        };
    ...
    function fd(a, b, c, d) {
        ...
        else if (e === Qc || Kc(e)) e = Jc(e.slice()), F(a, b, e, d);
        return e
    }
    ...
    function id(a, b, c, d, e) {
        ...
        if (null == d) return d;
        Nc(d) && !Nc(a) && (d = d.Ma($b), F(a, c, d.D, e), a.i[c] = d);
        return d
    }
    ...
    function jd(a, b, c, d) {
        ...
        if (!f) {
            ...
            for (var h = 0; h < d.length; h++) {
                ...
                e = e || Kc(k);
                k = Xc(k, b);
                void 0 !== k && (f.push(k), g && Lc(k.D))
            }
            g && (Lc(f), Object.freeze(f));
            a.i[c] = f;
            Mc(d, !e)
        }
        return f
    ...
    function od(a, b, c) {
        ...
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.Z, (d = this.D[a]) ? Array.isArray(d) && Jc(d) : this.D[a] = Qc;
                else {
                    d = dd(this);
                    var e = d[a];
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length) {
                            ...
                            if (h) {
                                for (h = 0; h < f.length; h++)(k = f[h]) && Nc(k) && !l && (f[h] = f[h].Ma($b), g[h] = f[h].D);
                                Mc(g, !0)
                            }
                            for (l = 0; l < Math.min(f.length, e.length); l++) sd(f[l], e[l])
                        }
                    } else(f = id(a, e.constructor,
                        g, void 0, f)) && sd(f, e)
                }
            }
        }
    ...
    function vd(a, b, c, d, e, f) {
        (a = a.i && a.i[c]) ? Array.isArray(a) ? (e = f.Ca ? Jc(a.slice()) : a, ld(b, 0 < e.length ? e[0].constructor : void 0, c, e)) : H(b, a.constructor, c, a): (yc && d instanceof Uint8Array ? e = d.length ? new Bc(new Uint8Array(d)) : Ac || (Ac = new Bc(null)) : (Array.isArray(d) && (e ? Lc(d) : Fc(d) && f.Ca && (d = d.slice())), e = d), F(b, c, e))
    };
    ...
    */
    ...
    function be(a) {
        ...
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new Yd(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? Ud(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && $d(b) && ((b = ae("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = ae("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, ge[c]) c = ge[c];
                    else {
                        c = String(c);
                        if (!ge[c]) {
    ...
    pe.prototype.add = function (a, b, c, d, e) {
        ...
        var g = qe(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ra = !1)) : (b = new ne(b, this.src, f, !!d, e), b.ra = c, a.push(b));
        return b
    };
    pe.prototype.remove = function (a, b, c, d) {
        ...
        b = qe(e, b, c, d);
        return -1 < b ? (oe(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.i--), !0) : !1
    };

    function re(a, b) {
        var c = b.type;
        c in a.listeners && eb(a.listeners[c], b) && (oe(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }
    ...
    function ve(a, b, c, d, e) {
        if (d && d.once) we(a, b, c, d, e);
        else if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) ve(a, b[f], c, d, e);
        else c = xe(c), a && a[le] ? a.S(b, c, Pa(d) ? !!d.capture : !!d, e) : ye(a, b, c, !1, d, e)
    }
    ...
    function ye(a, b, c, d, e, f) {
        ...
        if (!c.proxy) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) ie || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    function we(a, b, c, d, e) {
        ...
        else c = xe(c), a && a[le] ? a.l.add(String(b), c, !0, Pa(d) ? !!d.capture : !!d, e) : ye(a, b, c, !0, d, e)
    }

    function De(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) De(a, b[f], c, d, e);
        else(d = Pa(d) ? !!d.capture : !!d, c = xe(c), a && a[le]) ? a.l.remove(String(b), c, d, e) : a && (a = ze(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = qe(b, c, d, e)), (c = -1 < a ? b[a] : null) && Ee(c))
    }
    ...
    function Ee(a) {
        if ("number" !== typeof a && a && !a.la) {
            ...
            if (b && b[le]) re(b.l, a);
                ...
                ue--;
                (c = ze(b)) ? (re(c, a), 0 == c.i && (c.src = null, b[se] = null)) : oe(a)
            }
        }
    }
    ...
    function Ge(a, b) {
        ...
        a = a.Aa;
        c = b.type || b;
        "string" === typeof b ? b = new de(b, a) : b instanceof de ? b.target = b.target || a : (e = b, b = new de(c, a), pb(b, e));
        e = !0;
        if (d)
        ...
        b.l || (g = b.i = a, e = He(g, c, !0, b) && e, b.l || (e = He(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.l && f < d.length; f++) g = b.i = d[f], e = He(g, c, !1, b) && e
    }
    J.prototype.ia = function () {
        ...
        if (this.l) {
            ...
            for (c in a.listeners) {
                for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, oe(d[e]);
    ...
    function Ke(a) {
        a.C = a.K.M(function () {
            var b;
            return x(function (c) {
                if (1 == c.i) return a.i ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.s(3) : w(c, Je(a), 3) : w(c, Je(a), 3);
                Ke(a);
                c.i = 0
            })
        }, 3E4)
            ...
            return x(function (h) {
                switch (h.i) {
                    ...
                    case 3:
                        ...
                        g !== a.i && (a.i = g, a.i ? Ge(a, "networkstatus-online") : Ge(a, "networkstatus-offline"));
                        c(g);
                        Ba(h);
                        break;
                    case 2:
    ...
    function sf() {
        if (A.Promise && A.Promise.resolve) {
            var a = A.Promise.resolve(void 0); of = function () {
                a.then(tf)
            }
        } else of = function () {
            var b = tf;
    ...
    function Cf(a) {
        if (a instanceof Df || a instanceof Ef || a instanceof Ff) return a;
        if ("function" == typeof a.next) return new Df(function () {
            return a
        });
        if ("function" == typeof a[Symbol.iterator]) return new Df(function () {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.L) return new Df(function () {
            return a.L()
        });
    ...
    function Gf(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Gf)
                for (c = Hf(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    n.delete = function (a) {
        return Jf(this.j, a) ? (delete this.j[a], --this.size, this.l++, this.i.length > 2 * this.size && If(this), !0) : !1
    };
    ...
    function If(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], Jf(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    n.get = function (a, b) {
    ...
    n.set = function (a, b) {
        Jf(this.j, a) || (this.size += 1, this.i.push(a), this.l++);
        this.j[a] = b
    };
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? qg(c, b) : (f ? (d = f, d.next == c.o && (c.o = d), d.next = d.next.next) : rg(c), sg(c, e, 3, b)))
                }
                a.l = null
            } else Of(a, 3, b)
    }
    ...
    function Of(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.u = c, a.i = b, a.l = null, ug(a), 3 != b || c instanceof pg || wg(a, c))
        }
    }
    ...
    Nf.prototype.C = function () {
        for (var a; a = rg(this);) sg(this, a, this.i, this.u);
        this.v = !1
    };
    ...
    function Lg(a, b) {
        ...
        if (c) {
            Mg || (Mg = new Gf);
            this.i = Mg.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), Mg.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    n.L = function (a) {
        ...
        d.next = function () {
            if (b >= c.length) return Af;
            var e = c[b++];
            if (a) return Bf(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1));
            e = e.nodeValue;
            if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered";
            return Bf(e)
        };
    ...
    var uh = [23, 24, 11, 6, 7, 5, 2, 3, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164, 168, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258, 259, 260, 261, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248, 249, 251, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 334, 337, 338, 340, 344, 348, 350, 351, 352, 353, 354, 355, 356, 357,
        358, 361, 363, 364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412, 429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117
    ];
    ...
    var zh = [3];
    var Ah = A.window,
        Bh, Ch, Dh = (null == Ah ? void 0 : null == (Bh = Ah.yt) ? void 0 : Bh.config_) || (null == Ah ? void 0 : null == (Ch = Ah.ytcfg) ? void 0 : Ch.data_) || {};
    C("yt.config_", Dh);
    ...
    function Kh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = N("ERRORS", []), e.push([a, "ERROR", b, c, d]), Eh("ERRORS", e));
        Ih(a)
    }

    function Lh(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = N("ERRORS", []), e.push([a, "WARNING", b, c, d]), Eh("ERRORS", e))
    };
    var Mh = 0;
    ...
    function Oh(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in Nh || (this[b] = a[b]);
    ...
    function Th(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                g = Jh(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Sh() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                lb[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function hi(a) {
        ...
        b = (ba.vis =
            b.prerendering ? 3 : {
                ...
                preview: 4,
                unloaded: 5
            } [b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, ba.wgl = !!xd.WebGLRenderingContext, ba);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    function oi(a, b) {
        ...
        if (c || !Qb(a)) b["X-YouTube-Ad-Signals"] = ai(hi());
        return b
    }
        ...
        var d = si(a, b),
            ...
            f = ti(a, function (k) {
                if (!e) {
                    ...
                    if (l || q || t) m = ui(a, c, k, b.convertToSafeHtml);
    ...
    function ri(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = ci(a, b || {}, !0);
        return a
    }
    ...
    function si(a, b) {
        ...
        f && "string" === typeof e && (e = bi(e), pb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Xb(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!ni && a && "POST" != b.method && (ni = !0, Kh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Lh(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? vi(a) : null) e = {}, D(a.getElementsByTagName("*"), function (g) {
                    e[g.tagName] = wi(g)
                })
        }
        d && xi(e);
    ...
    function Gi() {
        return {
            ...
            ub: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
                !1),
    ...
    function Mi(a) {
        ...
        Ki(a, c);
        Li(c);
        N("DELEGATED_SESSION_ID") && !O("pageid_as_header_web") && (a = new bh, F(a, 3, N("DELEGATED_SESSION_ID")));
    ...
    function Ii(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                ...
                null !== d && F(c, 3, d);
                H(b, Ug, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = zi())
    }
    ...
    function Li(a, b) {
        ...
        d && (a ? F(a, 61, Bi[d]) : b && (b.client.connectionType = d));O("web_log_effective_connection_type") && (d = Ei(), d = null != d && d.effectiveType ? Di.hasOwnProperty(d.effectiveType) ? Di[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d && (a ? F(a, 94, Ci[d]) :
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(Q()) - d.requestTime)) {
                    var e = d.authState,
                        f = Oi(Ni(!1));
                    mb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(Q())), Wi(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Si().set("requests", b, 86400, !0)
    ...
    function Zi(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Uh(a, c || 0)
    }
    ...
    function xj(a, b, c, d) {
        ...
        if (e instanceof vj) return new T("MISSING_INDEX", Object.assign({}, a, {
    ...
    U.all = function (a) {
        return new U(new Bj(function (b, c) {
            ...
            for (var f = {
                    ...
                    ca: f.ca
                }, ++f.ca) Cj(U.resolve(a[f.ca]).then(function (g) {
                return function (h) {
                    d[g.ca] = h;
                    e--;
                    0 === e && b(d)
        ...
        return x(function (G) {
            switch (G.i) {
                ...
                case 2:
                    ...
                    return w(G, K, 6);
                case 6:
                    return m = G.j, q = Math.round(Q()), Ek(a, k, q, g, void 0, b.join(), e), G.return(m);
                case 4:
                    t = za(G);
                    p = Math.round(Q());
                    y = xj(t, a.i.name, b.join(), a.i.version);
                    if ((z = y instanceof T && !y.i) || g >= f) Ek(a, k, p, g, y, b.join(), e), h = y;
                    G.s(2);
                    break;
                case 3:
    ...
    function Ek(a, b, c, d, e, f, g) {
        ...
        }), e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), ij("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            ...
            return x(function (z) {
                switch (z.i) {
                    ...
                    case 4:
                        ...
                        if (a.v < fi("ytidb_reopen_db_retries", 0)) return a.v++, h.close(), hj(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
        ...
        return x(function (e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = cj) f = /WebKit\/([0-9]+)/.exec(Kb()), f = !!(f && 600 <= parseInt(f[1], 10));
    ...
    function el(a) {
        if (!kj()) throw a = new T("AUTH_INVALID", {
            dbName: a
        }), hj(a), a;
        var b = lj();
        return {
    ...
    function fl(a, b, c, d) {
        ...
        return x(function (m) {
            switch (m.i) {
                ...
                case 2:
                    g = m.j;
                    if (!g) throw h = yj("openDbImpl", a, b), O("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), hj(h), h;
                    mj(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
    ...
    function ol(a) {
        nl(a) && !a.ha && (a.i = !0, a.va && Math.random() <= a.ta && a.F.ob(a.A), pl(a), a.H.G() && a.na(), a.H.S(a.Ja, a.na.bind(a)), a.H.S(a.Ia, a.Pa.bind(a)))
    }
    n = ml.prototype;
    ...
    n.sendThenWrite = function (a, b, c) {
        ...
        } else this.U(a, b, this.B && this.B("nwl_skip_retry") && c)
    };
    ...
    n.na = function () {
        ...
        this.j || (this.j = this.K.M(function () {
            var b;
            return x(function (c) {
                if (1 == c.i) return w(c, a.F.Ua("NEW", a.A), 2);
                if (3 != c.i) return b = c.j, b ? w(c, ql(a, b), 3) : (a.Pa(), c.return());
                a.j && (a.j = 0, a.na());
                c.i = 0
            })
        }, this.hb))
    ...
    function pl(a) {
        ...
        a.F.Ua("QUEUED", a.A).then(function (b) {
            b && !sl(a, b, a.cb) ? a.K.M(function () {
                return x(function (c) {
                    if (1 == c.i) return void 0 === b.id ? c.s(2) : w(c, a.F.Ka(b.id, a.A), 2);
                    pl(a);
                    c.i = 0
                })
            }) : a.H.G() && a.na()
    ...
    function El(a, b) {
        ...
        return x(function (l) {
            ...
            if (3 != l.i) return d = l.j, e = N("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, Q()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, Kj(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    I: !0
                }, function (m) {
    ...
    function Rl(a) {
        ...
        var c = void 0 === c ? !1 : c;
        if (a)
            if (b) ti(a, void 0, "POST", b);
            else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) ti(a, void 0, "GET", "", void 0, void 0, c);
        else {
            b: {
                try {
                    var d = new Za({
    ...
    function Z() {
        ...
        this.C = this.m = !1;
        this.j = this.Da();
        O("use_shared_nsm") ? (this.i = Le(), O("use_shared_nsm_and_keep_yt_online_updated") && (this.i.S("networkstatus-online", function () {
            a.j = !0;
            a.C && Xl()
    ...
    n.xb = function (a) {
        !O("use_shared_nsm") && (this.m = !0, void 0 === a ? 0 : a) && (this.pa || bm(this))
    };
    n.Da = function () {
    ...
    n.V = function (a) {
        ...
        return this.u ? this.u : this.u = new Promise(function (d) {
            ...
            return x(function (k) {
                switch (k.i) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, xa(k, 2, 3), e && (b.P = Me.M(function () {
                            e.abort()
                    ...
                    case 3:
                        ...
                        b.u = void 0;
                        b.P && Me.aa(b.P);
                        h !== b.j && (b.j = h, b.j && b.m ? Ge(b, "ytnetworkstatus-online") : b.m && Ge(b, "ytnetworkstatus-offline"));
                        d(h);
                        Ba(k);
                        break;
                    case 2:
    ...
    function dm(a, b) {
        a.za ? a.j ? (Me.aa(a.P), a.P = Me.M(function () {
            a.C !== b && (Ge(a, b), a.C = b, a.j = Q())
        }, a.za - (Q() - a.j))) : (Ge(a, b), a.C = b, a.j = Q()) : Ge(a, b)
    };
    var em;
    ...
    function im() {
        ...
        a || (a = new fm, C("yt.networklessRequestController.instance", a), O("networkless_logging") && dl().then(function (b) {
            a.A = b;
            ol(a);
            a.l.resolve();
    ...
    var lm = 0,
        mm = 0,
        nm, om = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
    ...
    function pm(a, b) {
        function c(d) {
            var e = qm().G();
            if (!rm() || !d || e && O("vss_networkless_bypass_write")) sm(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
    ...
    function vm() {
        ...
        lm || (lm = Me.M(function () {
            ...
            return x(function (c) {
                ...
                if (3 != c.i) return b = c.j, b ? w(c, tm(b), 3) : (Me.aa(lm), lm = 0, c.return());
                lm && (lm = 0, vm());
                c.i = 0
            })
        }, 100))
    ...
    function tm(a) {
        ...
        return x(function (e) {
            switch (e.i) {
                ...
                case 8:
                    sm(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    ...
    function wm(a) {
            ...
            return x(function (l) {
                switch (l.i) {
                    ...
                    case 6:
                        return l.return();
                    case 2:
                        if (O("nwl_consider_error_code") && !g && xm() > fi("potential_esf_error_limit", 10)) return l.return();
        ...
        a.options.onSuccess = function (e, f) {
            var g;
            return x(function (h) {
                if (1 == h.i) return O("use_cfr_monitor") && Tl().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.s(2) : w(h, Hl(a.id, b), 2);
                O("vss_network_hint") && qm().T(!0);
                d(e, f);
                h.i = 0
            })
    ...
    function Wi(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y;
            var z;
            if (d.retry && "www.youtube-nocookie.com" != h && (y || O("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (z = Ti(b, c, l, k)), z)) {
                var G = g.onSuccess,
                    K = g.onFetchSuccess;
            ...
            try {
                y && d.retry && !d.ab.bypassNetworkless ? (g.method = "POST", d.ab.writeThenSend ? O("use_new_nwl_wts") ? im().writeThenSend(p, g) : pm(p, g) : O("use_new_nwl_saw") ? im().sendAndWrite(p, g) : um(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), qi(p, g))
            } catch (M) {
                if ("InvalidAccessError" == M.name) z && (Ui(z), z = 0), Lh(Error("An extension is blocking network request."));
                else throw M;
            }
            z && Yi(function () {
                Vi(a)
        ...
        var p = ci("" + h + m, q || {}, !0);
        O("use_new_nwl") && im().i || !O("use_new_nwl") &&
            rm() ? bl().then(function (y) {
                e(y)
            }) : e(!1)
    };
    var zm = {
    ...
    function Um() {
        O("jspb_with_transport_leader") && !Gm.ytExports.logging.transport.leaderChosen && (Jm = Gm.ytExports.logging.transport.leaderChosen = !0, document.addEventListener("FLUSH_REQUEST", function () {
            Vm(void 0, void 0, !0)
        }))
    }
    ...
    function Zm(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            if (O("jspb_with_transport_leader") && Jm) {
                ...
                d.push(a.payload);
                Ym(b, d, c, !0)
            } else d = Rm.get(c) || [], Rm.set(c, d), a = a.payload.toJSON(), d.push(a), Ym(b, d, c, !0)
        }
    }
    ...
    function Ym(a, b, c, d) {
        ...
        O("jspb_with_transport_leader") && (Jm && b.length + g.length >= a || !Jm && Gm.ytExports.logging.transport.leaderQueueLength + b.length >= a) || b.length >= a ? Vm({
            writeThenSend: !0
        }, O("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && ($m(d), d ? Nm.l = e : Mm.l = e)
    }
    ...
    function Xm(a, b) {
        ...
        if (a.ga) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                Tm[b] = d
            } else b = a.R, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Sm[a.R.token] = c;
            c = a.R.token
        }
        return c
    }
    ...
    function Vm(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new Nf(function (d, e) {
            c ? (window.clearTimeout(Nm.j), window.clearTimeout(Nm.i), Nm.i = 0) : (window.clearTimeout(Mm.j), window.clearTimeout(Mm.i), Mm.i = 0);
            if (O("jspb_with_transport_leader") && !Jm) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
                ...
                if (void 0 !== b)
                    if (c) {
                        ...
                        var f = new Map,
                            g = Rm.get(b) || [];
                        e.set(b, g);
                        O("jspb_with_transport_leader") && (g = Qm.get(b) || [], f.set(b, g));
                        dn(e, f, d, a);
                        Rm.delete(b)
                    } else f = new Map, g =
                        Pm.get(b) || [], f.set(b, g), bn(f, d, e, a), Pm.delete(b);
            else c ? (dn(Rm, Qm, d, a), Rm.clear()) : (bn(Pm, d, e, a), Pm.clear());
            else $m(c), d()
        })
    }
    ...
    function bn(a, b, c, d, e) {
        ...
        for (var k = a.next(); !k.done; k = a.next()) {
            ...
            try {
                Wi(f, "log_event", k, hn(d, l, m, q, e)), Om = !1
            } catch (t) {
                Kh(t), c()
            }
        }
    ...
    function dn(a, b, c, d, e) {
        ...
        for (var l = k.next(); !l.done; l = k.next()) {
            ...
            q = q ? jn(q) : [];
            q = u(q);
            for (p = q.next(); !p.done; p = q.next()) md(l, 3, th, p.value);
            t = u(t);
            for (q = t.next(); !q.done; q = t.next()) md(l, 3, th, q.value);
            (t = Tm[m]) && kn(l, m, t);
            delete Tm[m];
    ...
    function fn(a, b, c) {
        ...
        !c && (b = N("EVENT_ID")) && (c = mn(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function qn(a, b) {
        ...
        a: {
            ...
            if (O("lr_drop_other_and_business_payloads")) {
                if (Am[a] || zm[a]) break a
            } else if (O("lr_drop_other_payloads") && Am[a]) break a;
            var e = {},
                f = Math.round(c.timestamp || Q());e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0;e[a] = b;a = Bm();e.context = {
                lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a)
            };O("log_sequence_info_on_gel_web") && c.ma && (a = e.context, b = c.ma, b = {
                    index: pn(b),
                    groupKey: b
                }, a.sequence =
                b, c.rb && delete nn[c.ma]);
            (c.zb ? an : Wm)({
                endpoint: "log_event",
                payload: e,
                R: c.R,
    ...
    function An(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Bn(d, a[d], b, c), 500 < e)); d++);
                d = e
    ...
    function Xn(a, b, c) {
        Yn || (Yn = {}, Th(window, "message", function (d) {
            a: {
                if (d.origin === Wn(a, "host")) {
                    ...
                    if (d = Yn[e.id]) d.u = !0, d.u && (D(d.v, d.sendMessage, d), d.v.length = 0), d.Oa(e)
                }
                e = void 0
            }
            return e
    ...
    function fo(a, b) {
        ...
        (b = Wn(a.j, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.Ra();
        ...
        Zn.yt_embedsTokenValue && (g.embedsTokenValue = encodeURIComponent(Zn.yt_embedsTokenValue), delete Zn.yt_embedsTokenValue);
    ...
    n.setup = function (a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Rb(a.src) : "https://www.youtube.com"), this.j = new Vn(b), c || (b = fo(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.i = a, this.i.id || (this.i.id = "widget" + Qa(this.i)), Pn[this.i.id] = this, window.postMessage) {
                this.o = new L;
                go(this);
                b = Wn(this.j, "events");
    ...
    function bo(a, b) {
        a.J[b] || (a.J[b] = !0, eo(a, "addEventListener", [b]))
    }
                        ...
                        if (f) {
                            ...
                            if (!(5 <= Gn)) {
                                ...
                                if (t.hasOwnProperty("args") && t.args && t.args.length)
                                    for (var na = 0; na < t.args.length && !(va = An(t.args[na], "params." + na, p, va), 500 <= va); na++);
                                ...
                                if (Jn.length)
                                    for (var X =
                                            0; X < Jn.length && !(va = An(Jn[X], "params.context." + X, p, va), 500 <= va); X++);
                                    ...
                                    if (Sf.xa[S.name])
                                        for (var Xj = u(Sf.xa[S.name]), Tf = Xj.next(); !Tf.done; Tf = Xj.next()) {
                                            ...
                                            if (Ld) {
                                                ...
                                                for (var Uf = Yj.groups, Zj = {}, Ub = 0; Ub < Uf.length; Ub++) Zj[Uf[Ub]] = Ld[Ub + 1], S.params["params.error." + Uf[Ub]] = Ld[Ub + 1];
                                                S.message = Sf.Ha(Zj);
                                                break
                                            }
                                        }
                                ...
                                if (0 !== ra.sampleWeight && !Fn.has(ra.message)) {
                                    if ("ERROR" === h) {
                                        ...
                                        if (O("record_app_crashed_web") &&
                                            0 === In && 1 === ra.sampleWeight)
                                            if (In++, O("errors_via_jspb")) {
                                                var Vf = new qh;
                                                F(Vf, 1, 1);
                                    ...
                                    if (O("kevlar_gel_error_routing")) a: {
                                        ...
                                        if (O("errors_via_jspb")) {
                                            if (Ln()) Xf = void 0;
                                                ...
                                                0 !== Ja.length && (1 !== Ja.length || isNaN(Number(Ja[0])) ? 2 !== Ja.length || isNaN(Number(Ja[0])) || isNaN(Number(Ja[1])) || (F(Vb, 2, Number(Ja[0])), F(Vb, 3, Number(Ja[1]))) : F(Vb, 2, Number(Ja[0])));
                                                var qb = new lh;
                                                F(qb, 1, R.message);
                                                F(qb, 3, R.name);
                                            ...
                                            if (Ln()) Wf = void 0;
                                                ...
                                                R.fileName && (Hc.filename =
                                                    R.fileName);
                                                var Ka = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Ka.length && (1 !== Ka.length || isNaN(Number(Ka[0])) ? 2 !== Ka.length || isNaN(Number(Ka[0])) || isNaN(Number(Ka[1])) || (Hc.lineNumber = Number(Ka[0]), Hc.columnNumber = Number(Ka[1])) : Hc.lineNumber = Number(Ka[0]));
                                                var fg = {
                                        ...
                                        if ("ERROR" === Gc || O("errors_flush_gel_always_killswitch")) O("web_fp_via_jspb") && on(!0),
                                        on()
                                    }
                                    if (!O("suppress_error_204_logging")) {
                                        ...
                                        if ($a.postParams) {
                                            ...
                                            var Ck = N("SERVER_NAME"),
                                                Dk = N("SERVER_VERSION");
                                            Ck && Dk && ($a.postParams["server.name"] = Ck, $a.postParams["server.version"] = Dk)
                                        }
    ...
    n.Oa = function (a) {
        ...
        switch (b) {
            ...
            case "initialDelivery":
                Pa(a) && (window.clearInterval(this.l), this.playerInfo = {}, this.N = {}, lo(this, a.apiInterface), ko(this, a));
                break;
            default:
                ao(this, b, a)
        }
    ...
    n.getVideoEmbedCode = function () {
        ...
        b = Math.floor(b);
        c = Math.floor(c);
        Gb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Ab, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(Bb, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Cb, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Db, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Eb, "&#39;")), -1 != a.indexOf("\x00") &&
            (a = a.replace(Fb, "&#0;")));
    ...
    C("YT.subscribe", function (a, b, c) {
        Ag.subscribe(a, b, c);
        Rn[a] = !0;
        for (var d in Pn) Pn.hasOwnProperty(d) && co(Pn[d], a)
    });
